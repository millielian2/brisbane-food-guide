...
"description": "A drinks stop in Brisbane City. Downloading the Cotti app gives you three introductory drink vouchers for $3.59 each. After that, more drink vouchers become available every few days, usually for $4.90. The vouchers can be used on most drinks, although some drinks may cost more or less."
},
...
<div class="restaurant-body">
  ...
  <div class="gallery">
    ${place.images.map(img =>
      `<img src="images/${img}" alt="${place.name} food photo" loading="lazy">`
    ).join("")}
  </div>
